...
:quickstart-project-name: quickstart-freeradius-mfa-workspace
:partner-product-name: WorkSpace FreeRADIUS MFA on AWS CLOUD
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: WorkSpace FreeRADIUS MFA on AWS CLOUD
...
:quickstart-contributors: Adeleke Coker, AWS Senior Solutions Architect
:aws-contributors: Hammad Raza, Charles Meruwoma, Mulalo Matamela, Kayode Sanni-Olodo AWS Premium Support Team
